...
export default function FetchCSVData(props) {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSJyvooj0kTpiz0IFGdYuKq-SnpqzeNOw_j8zDoo6BUJuDJkRRfoVWObuUWa3WiRQ/pub?output=csv'; // Replace with your Google Sheets CSV file URL
